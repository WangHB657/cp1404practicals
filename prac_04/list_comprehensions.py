...
# TODO: list comprehension to create a list of only the numbers that are greater than 9 from the numbers (not strings)
#  you just created
numbers_greater_than_9 = [number for number in numbers if number > 9]
print(numbers_greater_than_9)

# TODO: (more advanced) use a list comprehension and the join string method to create a string (not list) of the last
#  names for those full names longer than 11 charactersthe result should be: 'Harlem, Hendrix, Lovelace'
long_full_names = [name.split()[-1] for name in full_names if len(name) > 11]
print(long_full_names)
